...
- Every specimen can be flipped between its matched obverse and reverse photographs. On touchscreens, the specimen also supports direct two-finger zoom and bounded panning inside its frame; the full-screen viewer remains available as an alternative.
- An optional in-game guide uses ten annotated, two-sided, museum-verified examples from the United States, Japan, Hong Kong, France, Mexico, Brazil, China, Greece, Egypt, and Peru to explain useful clues such as issuers, dates, scripts, emblems, mint marks, and place names. Gameplay specimens and guide examples open in a full-screen detail viewer with adjustable zoom and in-place flipping.
